@echo off
setlocal
title Instalador do Conector Razync 1.3
color 0B
echo.
echo  ==========================================
echo       CONECTOR RAZYNC PARA WINDOWS 1.3
echo  ==========================================
echo.
