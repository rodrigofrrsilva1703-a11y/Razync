@echo off
setlocal
title Instalador do Conector Razync 1.6
color 0B
echo.
echo  ==========================================
echo       CONECTOR RAZYNC PARA WINDOWS 1.6
echo  ==========================================
echo.
