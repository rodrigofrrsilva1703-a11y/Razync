@echo off
setlocal
title Instalador do Conector Razync 1.0
color 0B
echo.
echo  ==========================================
echo       CONECTOR RAZYNC PARA WINDOWS 1.0
echo  ==========================================
echo.
